...
(function() {
	...
	/*таймеры*/
	var animation; //таймер обновления дисплея
	var ballMotion;	//перемещение мяча
	var speedTimer;	//таймер увеличения скорости перемещения мяча
