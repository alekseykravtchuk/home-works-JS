...
(function () {
  ...
  function checkField(input) {
    ...
    input.setAttribute('class', 'validate error');
    input.previousSibling.setAttribute('class', 'error');
    if(!input.value.trim()) {
      ...
      input.previousSibling.innerHTML = 'Неверный формат даты. Введите дату в формате dd.mm.yyyy.';
    } else {
      input.setAttribute('class', 'validate valid');
      input.previousSibling.setAttribute('class','valid');
    }
  }
